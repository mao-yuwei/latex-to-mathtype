...
namespace MTSDKDN
{
    ...
    public sealed class OLEHeader
    {
        public const String OLE_HEADER = "";
        public const String MTEF_HEADER = "HAAAAAIA2cKvBAAAAAAAAAAAAAAAAAAAAAAAAA==";
    }
    ...
    public class MathTypeSDK
    {
        ...
        public static byte[] OLE_HEADER_BYTE = Convert.FromBase64String(OLEHeader.OLE_HEADER);
        public static byte[] MTEF_HEADER_BYTE = Convert.FromBase64String(OLEHeader.MTEF_HEADER);
        ...
        public static String getOLEBase64(byte[] originalMTEFBytes)
        {
            int oleHeaderLenth = OLE_HEADER_BYTE.Length;
            int mtefHeaderLenth = MTEF_HEADER_BYTE.Length;
            int mtefLength = originalMTEFBytes.Length;
            int length = oleHeaderLenth + mtefHeaderLenth + mtefLength;
            /*if (length >= 5000) {
                Console.WriteLine("out of index length 5000");
                return null; 
            }
            byte[] oleBytes = new byte[5000];*/
            byte[] oleBytes = new byte[length];
            int index = 0;
            for (int i = 0; i < oleHeaderLenth; i++)
            {
                oleBytes[index++] = OLE_HEADER_BYTE[i];
            }
            for (int i = 0; i < mtefHeaderLenth; i++)
            {
                oleBytes[index++] = MTEF_HEADER_BYTE[i];
            }
            for (int i = 0; i < mtefLength; i++)
            {
                oleBytes[index++] = originalMTEFBytes[i];
            }
            return Convert.ToBase64String(oleBytes);
        }
